...
function ReviewsCard({ entity, type }) {
  const buttonStyle =
    "bg-white border border-red-500 hover:shadow-lg text-red-500 font-bold mx-auto mt-2 lg:text-2xl text-white hover:shadow-lg rounded-lg px-2 py-3 transition ease-in-out delay-110 hover:text-white hover:bg-red-500 hover:scale-110";
  if (type === "dormitories") {
    return (
      <div className="p-4 bg-white rounded-xl m-3">
       
        <h1 className="text-center font-bold h-10 text-lg lg:text-2xl mb-3">
          {entity.hostel_name}
        </h1>
        <Image
          height={300}
