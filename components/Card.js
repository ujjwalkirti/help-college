...
function Card({ option }) {
  return (
    <a
      href={`${option.url}`}
      className="border flex flex-col m-3 bg-white items-center p-2 rounded-md hover:shadow-xl justify-evenly transition ease-in-out delay-120 hover:scale-105 hover:bg-yellow-500 duration-300 relative"
    >
